...
useEffect(() => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
      ...
      <div className="col-span-2 bg-white shadow rounded-xl p-6 overflow-x-auto">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500">
            <button className="px-3 py-1 rounded border">Select Date</button>
            <button className="px-3 py-1 rounded border">Filters</button>
            <button className="bg-blue-100 text-blue-500 px-3 py-1 rounded font-medium">
              See All
            </button>
          </div>
        </div>
